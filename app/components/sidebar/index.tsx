...
const Sidebar: FC<ISidebarProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-[#131314] border-r border-slate-800/60 text-slate-100 w-16 flex-shrink-0 items-center justify-between py-4 select-none">
      {/* Bagian Atas */}
      ...
      <div className="flex flex-col items-center gap-3">
        {/* Settings */}
        <button title="Settings" className="p-2.5 text-slate-400 hover:text-slate-100 hover:bg-slate-800/80 rounded-xl transition-colors">
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Profil Avatar */}
        <button className="w-8 h-8 rounded-full overflow-hidden border border-slate-700 hover:ring-2 hover:ring-slate-500 transition">
